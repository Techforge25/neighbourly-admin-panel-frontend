...
interface RejectRecomendationsModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  name?: string | null;
...
const RejectRecomendationsModal: React.FC<RejectRecomendationsModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  name,
        ...
        <div className="flex flex-col items-center mt-2">
          ...
          <div className="flex flex-col w-full gap-3">
            ...
            <button
              ...
              onClick={onConfirm}
              disabled={isLoading}
              className="flex items-center justify-center gap-2 w-full py-3.5 bg-[#FF9A8A] hover:bg-[#FF8F7D] text-white text-[15px] font-medium rounded-full transition-colors disabled:opacity-50"
            >
              {isLoading ? "Rejecting..." : "Reject Recommendation"}
...
export default RejectRecomendationsModal;