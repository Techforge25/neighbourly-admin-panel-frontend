...
interface DeleteSponserModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
   name?: string | SuburbRecord | null;
  isLoading?: boolean;
}

const DeleteSponserModal: React.FC<DeleteSponserModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  name,
      ...
      <div className="w-full max-w-[480px] bg-white rounded-[16px] p-8 shadow-xl relative">
        ...
        <div className="flex flex-col items-center mt-2">
          ...
          <p className="text-[14px] text-[#6B7280] text-center leading-relaxed mb-8 px-2">
            Are you sure you want to delete <span className="font-medium text-[#374151]">  {typeof name === "string" ? name : name?.name}</span>? 
...
export default DeleteSponserModal;